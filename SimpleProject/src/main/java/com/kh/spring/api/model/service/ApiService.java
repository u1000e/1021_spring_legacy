...
public class ApiService {
	...
	public String requestBeef() {
		...
		final String API_KEY = "89201a25e842c551961aeeb58642307879394f6e5964d0a5ff1a627431fc47a8";
	...
	public String requestBlog(String query) {
        String clientId = "Rk7eIp6tqI_r5ZXIxjjS"; //애플리케이션 클라이언트 아이디
        String clientSecret = "R0TvxPp7HY"; //애플리케이션 클라이언트 시크릿
